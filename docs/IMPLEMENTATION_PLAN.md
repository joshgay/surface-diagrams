...
- P2 now implements circular planar holes, rim endpoints, clipping, clearance,
  ...
  P3a specification is written in docs/cut-systems.md; P3b validator remains. P4-P8 have not started. The current suite has 67 tests; see HANDOFF.md.
...
| P3 | Specify and validate disk-complement cut systems | In progress: P3a specification written; P3b remains | P0 |
