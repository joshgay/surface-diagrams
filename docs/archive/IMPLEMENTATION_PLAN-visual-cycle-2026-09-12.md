...
Historical archive: this was the controlling plan for the previous visual cycle.
The current [implementation plan](../IMPLEMENTATION_PLAN.md) supersedes its
sequencing; its feature-specific acceptance criteria remain reference material. Read it together
