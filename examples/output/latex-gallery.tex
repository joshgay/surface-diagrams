...
\clearpage
\begin{center}
\Large An annulus with an arc joining its boundaries\par\bigskip
\resizebox{0.95\linewidth}{!}{\SurfaceDiagram{circles-annulus.tikz}}
\end{center}
\clearpage
\begin{center}
\Large Circular holes: default row and sizes\par\bigskip
\resizebox{0.95\linewidth}{!}{\SurfaceDiagram{circles-default-row.tikz}}
\end{center}
\clearpage
\begin{center}
\Large Circular holes and marked points\par\bigskip
\resizebox{0.95\linewidth}{!}{\SurfaceDiagram{circles-mixed.tikz}}
\end{center}
\clearpage
\begin{center}
...
\clearpage
\begin{center}
\Large A straight arc joins two circle rims\par\bigskip
\resizebox{0.95\linewidth}{!}{\SurfaceDiagram{circles-straight.tikz}}
\end{center}
\clearpage
\begin{center}
\Large An arc above the row ends on the rims\par\bigskip
\resizebox{0.95\linewidth}{!}{\SurfaceDiagram{circles-up.tikz}}
\end{center}
\clearpage
\begin{center}
\Large A reversed arc below the row\par\bigskip
\resizebox{0.95\linewidth}{!}{\SurfaceDiagram{circles-down.tikz}}
\end{center}
\clearpage
\begin{center}
\Large An arc from a hole to a marked point\par\bigskip
\resizebox{0.95\linewidth}{!}{\SurfaceDiagram{circles-mixed-endpoints.tikz}}
\end{center}
\clearpage
\begin{center}
\Large An arc from the outer boundary to a hole\par\bigskip
\resizebox{0.95\linewidth}{!}{\SurfaceDiagram{circles-outer.tikz}}
\end{center}
\clearpage
\begin{center}
\Large A closed curve surrounds circular holes\par\bigskip
\resizebox{0.95\linewidth}{!}{\SurfaceDiagram{circles-loop.tikz}}
\end{center}
\clearpage
\begin{center}
\Large Numbered horizontal guides with a cut-crossing arc\par\bigskip
\resizebox{0.95\linewidth}{!}{\SurfaceDiagram{circles-numbered.tikz}}
\end{center}
\clearpage
\begin{center}
\Large Individual circle radii: 8, 14, 20\par\bigskip
\resizebox{0.95\linewidth}{!}{\SurfaceDiagram{circles-radii.tikz}}
\end{center}
\clearpage
\begin{center}
\Large Transparent holes on a colored background\par\bigskip
\resizebox{0.95\linewidth}{!}{\SurfaceDiagram{circles-colored.tikz}}
\end{center}
\clearpage
\begin{center}
