...
The integrity profile also builds and restores version-4 workspace recovery for
...
envelope bytes, the separate bounded native view state and inactive creation
draft state, the 32 MiB schema bound, endpoint hashes, and cache alignment.
