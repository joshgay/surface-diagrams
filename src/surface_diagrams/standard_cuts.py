...
class CutSystem:
    ...
    def diagram(self, *routes, show_ids=False, show_segments=False, intersections=()):
        from .cut_diagrams import CutDiskDiagram
        return CutDiskDiagram(self, tuple(routes), tuple(intersections), show_ids, show_segments)
